...
def llama_api_call(engine, prompt):
    llm =  Llama(modal_path="/home/safertek/.cache/llama.cpp/unsloth_Qwen3-30B-A3B-Thinking-2507-GGUF_Qwen3-30B-A3B-Thinking-2507-UD-Q8_K_XL.gguf",
                 )
